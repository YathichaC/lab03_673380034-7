...
//  ชื่อนักศึกษา : ญาทิชา จันทรศรีสุริยวงศ์
//  รหัสนักศึกษา : 673380034-7
// ╚══════════════════════════════════════════════════════════╝
//
//  โจทย์:
...
class ShippingCompany {
    ...
    public ShippingCompany(String name) {
        this.name = name;
        this.shipments = new ArrayList<>(); // เพิ่มบรรทัด initialize ตรงนี้
    }
    ...
    public void printSummary() {
        ...
        System.out.println("----------------------------------------");
        System.out.printf("ยอดรวมทั้งหมด : %.2f บาท%n", getTotalCost()); // 2) แสดงยอดรวมตรงนี้
        System.out.println("========================================");
    }
}
